...
@Disabled
public class TicketUserUserIdGetHandlerTest {
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(TicketUserUserIdGetHandlerTest.class);
    ...
    @Test
    public void testTicketUserUserIdGetHandlerTest() throws ClientException {
        ...
        String requestUri = "//ticket/user/GyqFzZXGxXKkwsMBeNHnZNbZQLlo";
