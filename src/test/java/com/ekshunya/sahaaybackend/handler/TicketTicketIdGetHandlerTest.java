...
@Ignore
public class TicketTicketIdGetHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(TicketTicketIdGetHandlerTest.class);
    ...
    @Test
    public void testTicketTicketIdGetHandlerTest() throws ClientException {
        ...
        String requestUri = "//ticket/zGEYvcyMsYL";
