...
@Ignore
public class TicketTicketIdPutHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(TicketTicketIdPutHandlerTest.class);
    ...
    @Test
    public void testTicketTicketIdPutHandlerTest() throws ClientException {
        ...
        String requestUri = "//ticket/NExDnunEpnIlyrvhexTEfLDpgR";
