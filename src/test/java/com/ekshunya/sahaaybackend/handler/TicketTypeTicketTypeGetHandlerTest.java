...
@Disabled
public class TicketTypeTicketTypeGetHandlerTest {
    public static TestServer server = TestServer.getInstance();
    static final Logger logger = LoggerFactory.getLogger(TicketTypeTicketTypeGetHandlerTest.class);
    ...
    @Test
    public void testTicketTypeTicketTypeGetHandlerTest() throws ClientException {
        ...
        String requestUri = "//ticket/type/mFAfGNfDHtCMqfFSXzGlzwePBVATc";
