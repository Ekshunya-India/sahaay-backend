...
@Ignore
public class TicketTicketIdCommentPostHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(TicketTicketIdCommentPostHandlerTest.class);
    ...
    @Test
    public void testTicketTicketIdCommentPostHandlerTest() throws ClientException {
        ...
        String requestUri = "//ticket/BODrCMitHMYd/comment";
