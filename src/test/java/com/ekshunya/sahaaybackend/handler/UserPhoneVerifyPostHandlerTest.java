...
@Ignore
public class UserPhoneVerifyPostHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(UserPhoneVerifyPostHandlerTest.class);
    ...
    @Test
    public void testUserPhoneVerifyPostHandlerTest() throws ClientException {
        ...
        String requestUri = "//user/phone/verify";
