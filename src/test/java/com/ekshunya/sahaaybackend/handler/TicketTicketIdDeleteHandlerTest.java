...
@Disabled
public class TicketTicketIdDeleteHandlerTest {
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(TicketTicketIdDeleteHandlerTest.class);
    ...
    @Test
    public void testTicketTicketIdDeleteHandlerTest() throws ClientException {
        ...
        String requestUri = "//ticket/wTTNleyLfGRvNg";
