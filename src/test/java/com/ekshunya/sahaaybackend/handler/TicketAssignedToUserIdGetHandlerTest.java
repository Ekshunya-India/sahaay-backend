...
@Ignore
public class TicketAssignedToUserIdGetHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(TicketAssignedToUserIdGetHandlerTest.class);
    ...
    @Test
    public void testTicketAssignedToUserIdGetHandlerTest() throws ClientException {
        ...
        String requestUri = "//ticket/assignedTo/Nhbjk";
