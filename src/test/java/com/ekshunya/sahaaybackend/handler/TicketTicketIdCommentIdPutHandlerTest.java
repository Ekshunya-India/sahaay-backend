...
@Ignore
public class TicketTicketIdCommentIdPutHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(TicketTicketIdCommentIdPutHandlerTest.class);
    ...
    @Test
    public void testTicketTicketIdCommentIdPutHandlerTest() throws ClientException {
        ...
        String requestUri = "//ticket/dVAQiaqXrIO/dVAQiaqXrIO";
