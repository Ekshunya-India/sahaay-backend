...
@Ignore
public class TicketTicketIdCommentIdDeleteHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(TicketTicketIdCommentIdDeleteHandlerTest.class);
    ...
    @Test
    public void testTicketTicketIdCommentIdDeleteHandlerTest() throws ClientException {
        ...
        String requestUri = "//ticket/zAJcMbDznKseJdmmNvsrNP/zAJcMbDznKseJdmmNvsrNP";
